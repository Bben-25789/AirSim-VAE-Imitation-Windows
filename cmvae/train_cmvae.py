...
output_dir = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/cmvae_con_train'
batch_size = 32
epochs = 30
n_z = 10
latent_space_constraints = True
img_res = 64
max_size = 50000  # default is None
learning_rate = 1e-4
