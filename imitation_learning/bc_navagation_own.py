...
if __name__ == "__main__":
    ...
    if policy_type == 'bc_con':
        ...
        bc_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/bc_con/bc_model_150.ckpt'
        feature_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/cmvae_con/cmvae_model_40.ckpt'
    elif policy_type == 'bc_unc':
        training_mode = 'latent'
        latent_space_constraints = False
        bc_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/bc_unc/bc_model_150.ckpt'
        feature_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/cmvae_unc/cmvae_model_45.ckpt'
    elif policy_type == 'bc_img':
        training_mode = 'latent'
        latent_space_constraints = True
        bc_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/bc_img/bc_model_100.ckpt'
        feature_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/cmvae_img/cmvae_model_45.ckpt'
    elif policy_type == 'bc_reg':
        training_mode = 'reg'
        latent_space_constraints = True
        bc_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/bc_reg/bc_model_80.ckpt'
        feature_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/reg/reg_model_25.ckpt'
    elif policy_type == 'bc_full':
        training_mode = 'full'
        latent_space_constraints = True
        bc_weights_path = 'F:/graduate student job/pycharm/AirSim_code/AirSim-Drone-Racing-VAE-Imitation-Windows-main/model_outputs/bc_full/bc_model_120.ckpt'
